    ...
    exports.init = function() {
        ...
        Session.prototype = {
            ...
            getSearch: function() {
                ...
                obj.prov = ($('#appver').val() == 'all' ? '' : $('#appver').val());;
                return obj;
            },
            ...
            getSearchInfo: function() {
                ...
                app.api({
                    ...
                    success: function(object) {
                        ...
                        for (var i = 0; i < object.value.model[18].length; i++) {

                            var option = document.createElement('option');
                            option.innerHTML = object.value.model[18][i].dimension;
                            option.setAttribute('value', object.value.model[18][i].value);

                            fragmentOne.appendChild(option);
                        }

                        $('#appver').append($(fragmentOne));
            ...
            getTopChart: function() { //顶部图表数据的请求和渲染
                ...
                app.api({
                    url: '/business/overview/times', //顶部图表数据的请求
                    type: 'POST',
                    data: tpQuery,
                    dataType: 'json',
                    success: function(resp) {
                        ...
                        var arr = sTableData.tbody.reverse();
                        ...
                        var lineChart = echarts.init(document.getElementById('lineUser'));
            ...
            getTwoChart: function() {
                ...
                app.api({
                    url: '/business/overview/user', //顶部图表数据的请求
                    type: 'POST',
                    data: tpQuery,
                    dataType: 'json',
                    success: function(resp) {
                        ...
                        chartOption.option.title.text = '功能使用人数趋势';
                        $('#titleTable').html('功能使用人数');
                        chartOption.option.xAxis.data = [];
                        for (var i = 0; i < chartOption.option.series.length; i++) {
                            chartOption.option.series[i].data = [];
                        }
            ...
            gettreeChart: function() {
                ...
                app.api({
                    url: '/business/overview/average', //顶部图表数据的请求
                    type: 'POST',
                    data: tpQuery,
                    dataType: 'json',
                    success: function(resp) {
                        ...
                        chartOption.option.title.text = '人均使用次数趋势';
                        $('#titleTable').html('人均使用次数');
                        chartOption.option.xAxis.data = [];
                        for (var i = 0; i < chartOption.option.series.length; i++) {
                            chartOption.option.series[i].data = [];
                        }
            ...
            getFourChart: function() {
                ...
                app.api({
                    url: '/business/overview/percent', //顶部图表数据的请求
                    type: 'POST',
                    data: tpQuery,
                    dataType: 'json',
                    success: function(resp) {
