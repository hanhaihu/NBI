define(function(require, exports, module) {
    exports.init = function() {
        ...
        var chartOption = require('../onlineTer/chart.js'); // 引入Echarts配置文件
        ...
        Session.prototype = {
            ...
            getSearchInfo: function() {
                ...
                app.api({
                    ...
                    success: function(object) {
                        ...
                        for (var i = 0; i < object.value.model[19].length; i++) {
                            var option = document.createElement('option');
                            option.innerHTML = object.value.model[19][i].dimension;
                            option.setAttribute('value', object.value.model[19][i].value);
                            fragmentOne.appendChild(option);
                        }

                        $("#terType").append($(fragmentOne)); //填冲终端类型
                    }
                });
            },
            initReset: function() {
            ...
            initBarChart: function(indicator, pillarChart) {
                ...
                chartOption.optionPillar.series[0].barWidth = "";

                chartOption.optionPillar.series[0].barCategoryGap = "30%";
            ...
            initLineChart: function(indicator, lineChart) {
                ...
                chartOption.option.title.text = "在线指标分移动端版本数据趋势";
            ...
            getTopChart: function() { //顶部图表数据的请求和渲染
                ...
                app.api({
                    url: 'operation/onlineapp/total', //顶部图表数据的请求
                    type: 'POST',
                    data: tpQuery,
                    dataType: 'json',
                    success: function(resp) {
                        ...
                        try {
                            ...
                            var pillarChart = echarts.init(document.getElementById('pieVer'));
                        ...
                        if (me.flag == false) {
                            ...
                            me.tableModule = new TableModule($('#tableOneVer')); //渲染顶部图表
            ...
            getBottomChart: function() {
                ...
                app.api({
                    url: 'operation/onlineapp/detail', //底部图表数据的请求和渲染;
                    type: 'POST',
                    data: btQuery,
                    dataType: 'json',
                    success: function(resp) {
                        ...
                        try {
                            ...
                            var lineChart = echarts.init(document.getElementById('lineVer'));
                        ...
                        if (me.flag == false) {
                            me.tableModuleTwo = new TableModule($('#tableTwoVer')); //渲染底部图表
