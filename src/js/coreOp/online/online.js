...
define(function(require, exports, module) {
    ...
    PageIncrease.prototype = {
        ...
        init: function() { //初始化
            ...
            $('.chartarea-btns button').on('click', function() {
                ...
                if (me.formatdata) {
                    ...
                    me.lineChart.setOption(me.formatdata.options[me.charttype]);
                }
            })
        ...
        refresh: function(info, dimensionname, dimension) {
            ...
            function check() {
                ...
                var fdata = me.formatdata = translate.format(onlineData, dimension, me.itemLength); //整理数据
                ...
                me.lineChart.setOption(fdata.options[me.charttype]) //渲染折线图;
            ...
            app.api({
                ...
                'success': function(resp) {
                    ...
                    if (resp.success) {
                        onlineData = resp.value.model; //获取企业数据
    ...
    exports.init = function() {
        ...
        pageIncrease.download = function() {
            window.open(BI.API_PATH + '/operation/online/down2?' + $.param(pageFilter.getDownloadInfo()));
        }
    }
});